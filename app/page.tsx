	...
	return (
		<div className="container mx-auto px-4 py-8">
				...
				<TabsContent value="host">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Como anfitrião, você pode criar um evento, gerar um QR code para
								seus convidados e gerenciar todas as fotos.
							</CardDescription>
						</CardHeader>
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
								<div className="flex flex-col items-center text-center p-4 border rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Gere um QR code único para seu evento
									</p>
								</div>
								<div className="flex flex-col items-center text-center p-4 border rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Acesse todas as fotos em um só lugar
									</p>
								</div>
								<div className="flex flex-col items-center text-center p-4 border rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Exporte e compartilhe as melhores fotos
									</p>
								</div>
							</div>
						</CardContent>
				...
				<TabsContent value="guest">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Como convidado, você pode acessar o evento através do QR code e
						...
						<CardContent className="grid gap-6">
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
								<div className="flex flex-col items-center text-center p-4 border rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Acesse o evento com o QR code fornecido
									</p>
								</div>
								<div className="flex flex-col items-center text-center p-4 border rounded-lg">
									...
									<p className="text-sm text-muted-foreground">
										Capture momentos especiais diretamente no app
									</p>
								</div>
								<div className="flex flex-col items-center text-center p-4 border rounded-lg">
									<Image className="h-10 w-10 mb-2 text-primary" />
									...
									<p className="text-sm text-muted-foreground">
										Visualize todas as fotos do evento
									</p>
								</div>
							</div>
						</CardContent>
			...
			<footer className="mt-20 text-center text-sm text-muted-foreground">
				<p>© 2025 EventSnap. Todos os direitos reservados.</p>
			</footer>
		</div>
	);
}
